...
$sql_current = "SELECT customer_id FROM queue3 WHERE status='serving' AND type='$window' LIMIT 1";
...
$sql_queued = "SELECT customer_id FROM queue3 WHERE status='queued' AND type='$window' ORDER BY customer_id ASC";
